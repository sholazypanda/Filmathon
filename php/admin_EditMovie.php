...
<div class="container-fluid text-center">
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <p><a href="#"></a></p>
      <p><a href="admin_AddMovie.php">Add Movie</a></p>
     
    </div>
    <div class="col-sm-8 text-left">
	<form action="admin_updateMovie.php" method="post" enctype="multipart/form-data">
	<div class="form-group row">
  	<label for="movieId" class="col-xs-2 col-form-label">Movie Id</label>
  	<div class="col-xs-10">
    <input class="form-control" type="text" value='<?php echo $movieID ?>' name="movieId" readonly>
  	</div>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
	  ...
	  <div class="col-xs-10">
	    <input class="form-control" type="text"  value='<?php echo $genre ?>' name="genre" placeholder="Adventure,Horror,Comedy,Family">
	  </div>
	</div>
		<div class="form-group row">
